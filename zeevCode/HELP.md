...
* [WebSocket](https://docs.spring.io/spring-boot/3.5.15-SNAPSHOT/reference/messaging/websockets.html)
* [OAuth2 Client](https://docs.spring.io/spring-boot/3.5.15-SNAPSHOT/reference/web/spring-security.html#web.security.oauth2.client)
* [OAuth2 Resource Server](https://docs.spring.io/spring-boot/3.5.15-SNAPSHOT/reference/web/spring-security.html#web.security.oauth2.server)
