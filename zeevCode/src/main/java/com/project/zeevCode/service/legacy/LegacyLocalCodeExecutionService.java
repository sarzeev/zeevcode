 ...
 */
@Service
@ConditionalOnProperty(name = "execution.provider", havingValue = "legacy-local-disabled")
@RequiredArgsConstructor
@Slf4j
public class LegacyLocalCodeExecutionService implements LegacyCodeExecutionService {
